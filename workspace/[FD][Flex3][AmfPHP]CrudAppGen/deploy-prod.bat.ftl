...
ECHO public var baseUrl:String = "${opt.productionServerUrl}"; > project\AmfPHPFlexCrud\src\modules\baseUrl.as
ECHO =========================
ECHO Compiling Flex sources...
ECHO =========================
CD "project\AmfPHPFlexCrud"
"${opt.flexSDKHome}\bin\mxmlc" -load-config+=obj\AmfPHPFlexCrudConfig.xml -incremental=true -benchmark=false -static-link-runtime-shared-libraries=true -link-report exclude.xml -o obj\AmfPHPFlexCrud634382418912941706
...
FOR /F "tokens=*" %%I IN (parsedModules.tmp) DO ( 
  "${opt.flexSDKHome}\bin\mxmlc" -load-config+=obj\%%IConfig.xml -incremental=true -benchmark=false -static-link-runtime-shared-libraries=true -load-externs=exclude.xml -o obj\%%I634382418913336756
